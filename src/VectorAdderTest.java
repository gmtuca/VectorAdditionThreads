...
public class VectorAdderTest {
    ...
    public void testAddThousandEntriesOneThread() {
        ...
        assertArrayEquals(VectorAdder.add(A,B, 1), expectedAdd(A,B));
    }
    ...
    public void testAddThousandEntriesTwoThreads() {
        ...
        assertArrayEquals(VectorAdder.add(A,B, 2), expectedAdd(A,B));
    }
    ...
    public void testAddThousandEntriesFivehundredThreads() {
        ...
        assertArrayEquals(VectorAdder.add(A,B, 500), expectedAdd(A,B));
    }
    ...
    public void testAddThousandEntriesThousandAndOneThreads() {
        ...
        assertArrayEquals(VectorAdder.add(A,B, 1001), expectedAdd(A,B));
    }
